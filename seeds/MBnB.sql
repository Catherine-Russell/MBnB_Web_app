...
INSERT INTO spaces (name, area, country, description, price, host_id, image_url, max_guests) VALUES ('Mediterranean Villa', 'Nice', 'France', 'In the heart of local life, this charming villa has superb panoramic views of the sea. You have the beach within easy reach, but are not too far away from the city to enjoy all the amenities Nice has to offer.', 281, 2, 'static/images/mediterraneanVilla.jpeg', 5);
INSERT INTO spaces (name, area, country, description, price, host_id, image_url, max_guests) VALUES ('English Cottage', 'Wimborne', 'UK', 'This chocolate box 16th Century Grade II listed cottage is full of the character you would expect from such an old property yet with just the right degree of up-dating to give you a comfortable stay: the perfect country retreat!', 150, 4, 'static/images/cottage.jpeg', 6);
...
INSERT INTO spaces (name, area, country, description, price, host_id, image_url, max_guests) VALUES ('Studio Apartment', 'New York', 'USA', 'Luxury 1 Bedroom in the heart of NYC! Central to all shopping, restaurants, and attractions. Highrise Apartment with Floor to Ceiling windows provide a breathtaking view of the River and Skyline.', 197, 2, 'static/images/studioApartment.jpeg', 2);
INSERT INTO spaces (name, area, country, description, price, host_id, image_url, max_guests) VALUES ('Tent', 'Tenby', 'UK', 'A 5 metre, cotton canvas bell tent which can comfortably accommodate up to 4 people with any combination of single beds or double bed, duvets and pillows with linen, rugs, blankets, cushions, lighting, side tables, seating and plants.', 75, 2, 'static/images/tent.jpeg', 4);
INSERT INTO spaces (name, area, country, description, price, host_id, image_url, max_guests) VALUES ('Bamboo Cabin', 'Tampaksiring', 'Indonesia', 'Located just a 20-minute scooter ride from the vibrant centre of Ubud, the Dome is a newly built one bedroom bamboo cabin situated within the Eco Six Resort.', 230, 3, 'static/images/cabin.jpeg', 3);
